...
2. Login.
* If you have a folder with the objects photos skip to step 4.
...
5. Choose 'Train' method from the dropdown – The machine performs deep learning of the images (It will take some time) and click Run.
